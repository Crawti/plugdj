/**
	Ahoj! Tohle je AutoWoot pro komunitu Crawti's Party.
	Tohle je zatím zkoušecí verze, pokud se bude líbit budeme pracovat s autowoot-em
	nadále. Pokud ne tak přestanem a budeme používát RCS-P3.
*/	
...
(function(){
	if (document.location.host.match(/plug\.dj$/i)){
		API.chatLog('Wait while plug# is loaded. This is an alpha version and we  will update this script in the next days and improve the new autowoot. To more info, check our facebook page or plug# page: https://www.facebook.com/origemwoot/ and https://www.facebook.com/plughash/');
		
		return $.getScript('https://rawgit.com/plughash/script/master/plughash.min.js');
	}
	var ow = {
		attr : {
			aw : true,	//autowoot
...
//					ow.gui.util.fixMenuLocation();
		...
		gui : {	//objeto de eventos e controle dos menus
			...
			pg : {	//controle de pĂˇgina do menu
				len: 4,
				now: 1,
				lock:false
			},
